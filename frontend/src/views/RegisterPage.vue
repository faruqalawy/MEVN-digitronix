        ...
        <div class="max-w-md w-full p-6">
          ...
          <form @submit.prevent="handleSubmit" class="space-y-4">
            <div>
              ...
              />
              <div
                v-if="formSubmitted && !$v.$pending && !$v.username.$pending && !$v.username.$model"
            ...
            <div>
              ...
              />
              <div
                v-if="formSubmitted && !$v.email.$pending && !$v.email.$model"
                class="text-red-500 text-sm"
              >
                Email is required
              </div>
              <div
                v-if="formSubmitted && !$v.email.email.$model && !$v.email.$pending"
                class="text-red-500 text-sm"
              >
            ...
            <div>
              ...
              />
              <div
                v-if="formSubmitted && !$v.password.$pending && !$v.password.$model"
                class="text-red-500 text-sm"
              >
                Password is required
              </div>
              <div
                v-if="formSubmitted && !$v.password.minLength.$model && !$v.password.$pending"
                class="text-red-500 text-sm"
              >
          ...
          <div class="mt-4 text-sm text-gray-600 text-center">
            <p>
              ...
              <a href="/login" class="text-black hover:underline">Login here</a>
            </p>
          </div>
        </div>
      </div>
