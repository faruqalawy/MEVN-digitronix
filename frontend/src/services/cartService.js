...
export const getCartItems = async () => {
  try {
    const response = await axios.get(API_URL, { withcredentials: 'include' })
    return response
  } catch (error) {
...
export const addToCart = async (newItem) => {
  try {
    const response = await axios.post(API_URL, newItem, { withcredentials: 'include' })
    return response
  } catch (error) {
...
export const deleteCartItem = async (item_id) => {
  try {
    await axios.delete(`${API_URL}/${item_id}`, { withcredentials: 'include' })
  } catch (error) {
...
export const clearCart = async () => {
  try {
    await axios.delete(API_URL, { withcredentials: 'include' })
  } catch (error) {
