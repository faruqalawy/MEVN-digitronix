<template>
  ...
  <div
    class="summary-toggle border-b-2 border-t-2 border-[#d9d9d9] bg-offWhite lg:hidden"
    @click="toggleCart"
  >
    <div class="custom-display flex justify-between p-5">
      <div class="flex gap-1.5">
        ...
        <i
          :class="[
            'fa-solid fa-chevron-down pt-0.5 transition-transform duration-300',
            { 'rotate-180': isCartOpen }
          ]"
        ></i>
      </div>
  ...
  <transition name="slide-down">
    <div v-if="isCartOpen || isLargeScreen" class="custom-display lg:custom-display-reset">
      ...
      <h3
        ...
        class="mt-10 mb-3 md:text-h2 underline underline-offset-8 hidden lg:block"
      >
        Your Order
      </h3>
